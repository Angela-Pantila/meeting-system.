...
import { CalendarCheck, Mail, Lock, ArrowRight } from 'lucide-react'
        ...
        <div className="relative w-full max-w-lg px-8">
          ...
          <div className="relative">
            ...
            <h2 className="mb-4 text-3xl font-bold text-white">
              Manage meetings<br />that matter.
            </h2>
            <p className="text-lg text-slate-400">
              Schedule, track decisions, and keep every team aligned — all in one place.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-1 items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              {mode === 'password'
                ? 'Prefer email code? Sign in with OTP'
